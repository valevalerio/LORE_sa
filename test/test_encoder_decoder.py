...
class EncDecTest(unittest.TestCase):
    ...
    def test_column_transformer_encoder_init_with_features_encoder(self):
        ...
        self.assertEqual("ColumnTransformerEncoder - features encoded: col1,col2,col3=Africa,col3=America,col3=Europe,colours=Black,colours=Blue,colours=Green,colours=Red,colours=White,education", one_hot_enc.__str__())
        self.assertEqual(encoded.tolist(),np.array([1, 2, 0, 0, 1, 0, 0, 1, 0, 0, 2]).reshape(1, -1).tolist())
    ...
    def test_tabular_encode(self):
        ...
        encoded = tabular_enc.encode([[1, 2, "Europe", "Graduate", "Green"]])
        self.assertEqual(encoded.tolist(),np.array([1, 2, 0, 0, 1, 0, 0, 1, 0, 0, 2]).reshape(1, -1).tolist())
    ...
    def test_tabular_decode(self):
        ...
        self.assertEqual( [1, 2, "Africa", "High School", 'White'], decoded.tolist())
